        ...
        <q-card square bordered class="q-pa-lg shadow-1">
          <q-card-section>
            <q-form class="q-gutter-md">
              <q-input square filled clearable v-model="nombre" type="text" label="Nombre Completo" />
              <q-input square filled clearable v-model="dni" type="text" label="DNI" />
              <q-input square filled clearable v-model="email" type="email" label="Username" />
